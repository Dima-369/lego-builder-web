      ...
      if (type === 1) {
        ...
        if (!pt) {
          throw {
            ...
            toString: function () {
              return "Unloaded part type: " + line.ID;
            },
          };
        }
        ...
        identityRotation.set(1, 0, 0, 0, 1, 0, 0, 0, 1);
        ...
        LDR.writePrettyPoints(LDR.makeEle(tr, "td", "line_desc"), [
          line.p1,
          line.p2,
        ]);
        LDR.makeEle(tr, "td", "line_cull").innerHTML = "-";
